...
const SEED_CONFIGS: Record<FormSpecies, SeedConfig> = {
  ...
  dairy: {
    ...
    formulaIngredients: [
      { ingredientId: '32a16dc0-d3e8-4ed8-8943-26f9f4d08e81', inclusionPct: 35, costPerTonne: 85 },
      { ingredientId: 'facd9d61-4037-4bee-bf13-f86639a8311b', inclusionPct: 20, costPerTonne: 320 },
      { ingredientId: '3ec92489-4098-4dc1-a0a2-37149150fb6b', inclusionPct: 20, costPerTonne: 420 },
      { ingredientId: 'd308ba74-a8b2-4b95-bd42-554f0f239c92', inclusionPct: 10, costPerTonne: 380 },
      { ingredientId: '176e6085-c209-4e9d-97f6-ac7fa0b9d6ff', inclusionPct: 10, costPerTonne: 180 },
      { ingredientId: '3eac2894-8e49-4165-b939-a4f04dbccf40', inclusionPct: 5,  costPerTonne: 650 },
    ],
    safetyRules: [
  ...
  beef: {
    ...
    formulaIngredients: [
      { ingredientId: '9998d80b-e343-4daa-adb8-6716ffd8cc52', inclusionPct: 40, costPerTonne: 380 },
      { ingredientId: 'd308ba74-a8b2-4b95-bd42-554f0f239c92', inclusionPct: 25, costPerTonne: 380 },
      { ingredientId: 'f6d5eb71-9563-4cf4-ac75-eb043487a7d0', inclusionPct: 15, costPerTonne: 280 },
      { ingredientId: 'e684454e-ec56-4092-b052-5ff26d1dc072', inclusionPct: 10, costPerTonne: 520 },
      { ingredientId: '19f3e739-2e16-4afb-a04b-e41e858d7e47', inclusionPct: 5,  costPerTonne: 260 },
      { ingredientId: '3eac2894-8e49-4165-b939-a4f04dbccf40', inclusionPct: 5,  costPerTonne: 650 },
    ],
    safetyRules: [
  ...
  sheep: {
    ...
    formulaIngredients: [
      { ingredientId: 'dfecc620-e2c0-48db-bcc1-0ab26464cfb6', inclusionPct: 50, costPerTonne: 180 },
      { ingredientId: 'd308ba74-a8b2-4b95-bd42-554f0f239c92', inclusionPct: 25, costPerTonne: 380 },
      { ingredientId: 'b60959a1-a362-4e33-9c5e-096e1d11ec28', inclusionPct: 15, costPerTonne: 340 },
      { ingredientId: '0eb8b9eb-b02d-4c31-9d53-04affa17e047', inclusionPct: 10, costPerTonne: 250 },
    ],
    safetyRules: [
  ...
  pig: {
    ...
    formulaIngredients: [
      { ingredientId: '52150009-53ef-4308-ab40-c29a0d39e008', inclusionPct: 60, costPerTonne: 450 },
      { ingredientId: 'd308ba74-a8b2-4b95-bd42-554f0f239c92', inclusionPct: 15, costPerTonne: 380 },
      { ingredientId: '67b661c4-1bb3-4417-ad9b-1e492955e68c', inclusionPct: 15, costPerTonne: 540 },
      { ingredientId: '2fe638ca-e38e-4821-88d8-778e14e33798', inclusionPct: 8,  costPerTonne: 380 },
      { ingredientId: '1a8e48c1-a457-49f5-8a9f-3460282ec390', inclusionPct: 2,  costPerTonne: 1200 },
    ],
    safetyRules: [
  ...
  poultry: {
    ...
    formulaIngredients: [
      { ingredientId: '3ec92489-4098-4dc1-a0a2-37149150fb6b', inclusionPct: 55, costPerTonne: 420 },
      { ingredientId: '52150009-53ef-4308-ab40-c29a0d39e008', inclusionPct: 20, costPerTonne: 450 },
      { ingredientId: '6b63d820-1d80-4b4f-980a-2c90689b0b4a', inclusionPct: 15, costPerTonne: 980 },
      { ingredientId: '08e9523c-2f67-4fa3-85ae-ec31633232d8', inclusionPct: 5,  costPerTonne: 1800 },
      { ingredientId: '1a8e48c1-a457-49f5-8a9f-3460282ec390', inclusionPct: 5,  costPerTonne: 1200 },
    ],
    safetyRules: [
